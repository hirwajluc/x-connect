        ...
        <div class="text-center">
            <h4><spring:message code="login.login_with_phone"/></h4>
							 ...
							 <tr height="33" valign="center">
							   ...
							   <td align="left" width="200"><input name="phone" type="text" placeholder="<spring:message code="login.phone"/>" autocorrect="off" autocapitalize="off" autocomplete="off" spellcheck="false" value="<c:out value="${ login_hint }" />" id="j_phone_number" name="j_phone_number" class="login_input_text" ></td>
							 </tr>
